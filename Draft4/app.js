...
function addTransaction({customerName, quantity, orderTotal, payment, employeeId, source, status}){
  ...
  const record = {
    ...
    orderTotal: Number(orderTotal), payment: Number(payment), change, employeeId,
